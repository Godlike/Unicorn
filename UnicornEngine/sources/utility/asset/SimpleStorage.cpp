...
uc::utility::asset::Handler uc::utility::asset::SimpleStorage::Get(const KeyType& key)
{
...
uc::utility::asset::Handler uc::utility::asset::SimpleStorage::ProcessHandlerCreation(const KeyType& key)
{
...
uc::utility::asset::Handler uc::utility::asset::SimpleStorage::CreateHandler(const KeyType& key)
{
