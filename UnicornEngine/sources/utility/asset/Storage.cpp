...
void uc::utility::asset::Storage::InitializeWorkers(uint16_t count)
{
...
uc::utility::asset::Handler uc::utility::asset::Storage::Get(const KeyType& key)
{
...
std::shared_future<uc::utility::asset::Handler> uc::utility::asset::Storage::GetAsync(const KeyType& key, uint32_t priority)
{
    std::pair<ConcurrentHandlerMap::iterator, bool> entry = m_entries.contains(key);
...
void uc::utility::asset::Storage::StopWorkers()
{
    if (!m_workers.empty())
    {
...
uc::utility::asset::Handler uc::utility::asset::Storage::ProcessHandlerCreation(const KeyType& key)
{
...
std::shared_future<uc::utility::asset::Handler> uc::utility::asset::Storage::ProcessAsyncHandlerCreation(const KeyType& key, uint32_t priority)
{
    std::pair<RequestsSet::iterator, bool> requestFlag;
...
uc::utility::asset::Handler uc::utility::asset::Storage::CreateHandler(const KeyType& key)
{
...
uc::utility::asset::Storage::Task::Task()
    : key(KeyType())
    , priority(0)
{
}

uc::utility::asset::Storage::Task::Task(Task&& other)
    : key(other.key)
...
uc::utility::asset::Storage::Task& uc::utility::asset::Storage::Task::operator=(Task&& other)
{
    key = other.key;
    priority = other.priority;
    promise = std::move(other.promise);
...
uc::utility::asset::Storage::Task uc::utility::asset::Storage::TaskQueue::Snatch(const KeyType& key)
{
...
uc::utility::asset::Storage::Task uc::utility::asset::Storage::TaskQueue::PopTop()
{
...
void uc::utility::asset::Storage::TaskQueue::UpdatePriority(const KeyType& key, uint32_t priority)
{
    for (container_type::iterator t = c.begin(); t != c.end(); ++t)
    {
        if (0 == key.compare(t->key))
...
void uc::utility::asset::Storage::WorkerThread()
{
...
uc::utility::asset::Storage::Storage()
    : m_workersStopFlag(false)
{
}
