...
namespace unicorn
{
	namespace video
	{
		namespace vulkan
		{
			ShaderProgram::ShaderProgram(vk::Device device, const std::string& vertShader, const std::string& fragShader) : m_isCreated(false), m_device(device)
			{
			...
			void ShaderProgram::CreateAttributeDescription()
			{
				...
				m_attributeDescription.at(0).setFormat(vk::Format::eR32G32Sfloat);
