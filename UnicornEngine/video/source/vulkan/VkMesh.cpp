    ...
    namespace video
    {
        namespace vulkan
        {
            ...
            void VkMesh::AllocateOnGPU()
            {
                ...
                //Vertexes filling
                auto size = sizeof(m_mesh->vertices[0]) * m_mesh->vertices.size();
                ...
                stagingBuffer.Write(m_mesh->vertices.data());
                stagingBuffer.CopyToBuffer(m_pool, m_queue, m_vertexBuffer, m_vertexBuffer.GetSize());
                stagingBuffer.Destroy();
                //Indexes filling
                size = sizeof(m_mesh->indices[0]) * m_mesh->indices.size();
                ...
                stagingBuffer.Write(m_mesh->indices.data());
