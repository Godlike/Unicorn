...
std::vector<const char*> VulkanContext::validationLayers = { "VK_LAYER_LUNARG_standard_validation" };
std::vector<const char*> VulkanContext::deviceExtensions = { VK_KHR_SWAPCHAIN_EXTENSION_NAME };
